...
const OrderSheet = () => {
  ...
  return (
    <div id="order-sheet" className="">
      <div className="flex items-center gap-3 mb-6">
        <FileText className="w-8 h-8 text-primary" />
        <div>
          <h1 className="text-3xl font-bold text-secondary mb-2">Order Sheet</h1>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              {/* Order Details */}
              <div>
                <h3 className="text-lg font-semibold text-secondary mb-4">Order Details</h3>
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-semibold text-secondary">Order Items</h3>
                  <button
                    type="button"
                    onClick={addItem}
